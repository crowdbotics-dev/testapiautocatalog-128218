...
## Project Structure
    ...
    ├── testapiautocatalog_128218  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_128218`
...
2. Clone this repo and `cd testapiautocatalog_128218`
